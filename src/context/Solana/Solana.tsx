...
import {SolanaNetwork, solanaNetworkToRPCURL} from "../../pkg/solana";

import {Connection} from '@solana/web3.js'
import SolanaWallet, {PhantomWallet} from "../../pkg/solana/wallet";
...
function SolanaContext({children}: { children?: React.ReactNode }) {
    ...
    const setSelectedSolanaWalletWithInit = async (provider: string) => {
    ...
    return (
        <Context.Provider
            value={{
                ...
                setSelectedSolanaWallet: setSelectedSolanaWalletWithInit,
                solanaWallets,
        ...
        >
            ...
            >
                <MenuItem
                    onClick={() => setSelectedSolanaWalletWithInit(PhantomWallet.metadata().provider)}
                >
                    <ListItemIcon>
                        <WalletIcon/>
                    </ListItemIcon>
